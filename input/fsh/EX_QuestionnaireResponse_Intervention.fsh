...
* item[=].item[=].item[=].answer.valueCoding = ChRadOrderRequestedService#ImagingRequestWithIntervention "Bildgebende Diagnostik und Intervention"
//------------------------------------------------------------------------
...
* item[=].item[=].item[=].answer.valueString = "Arterieller Verschluss; Dilatation?"
...
* item[=].item[=].item[=].answer.valueCoding = RDLX#RID10311	"imaging modality"
...
* item[=].item[=].item[=].answer.valueCoding = RDLX#RID2507	"Pelvis"

* item[=].item[=].item[+].linkId = "orderDetail.imagingFocus"
* item[=].item[=].item[=].text = "Fokus"
* item[=].item[=].item[=].answer.valueCoding = RDLX#RID50276	"set of pelvic arteries"
...
* item[=].item[=].item[=].answer.valueCoding = RDLX#RID11030 "Balloon dilation procedure"
