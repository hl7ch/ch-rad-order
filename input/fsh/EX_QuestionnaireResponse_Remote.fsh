...
* item[=].item[=].answer.valueDateTime = "2024-11-23T22:30:15+01:00"
...
* item[=].item[=].item[=].answer.valueCoding = ChRadOrderRequestedService#ImagingRequest "Bildgebende Diagnostik"
